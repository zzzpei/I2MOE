...
from src.ablation.SynergyRedundancyOnlyIMoE import SynergyRedundancyOnlyIMoE


def train_and_evaluate_synergy_redundancy_only(args, seed, fusion_model, fusion):
    """Train and evaluate interaction MoE with only synergy and redundancy branch.
    ...
    ensemble_model = SynergyRedundancyOnlyIMoE(
    ...
    visualize_sample_weights_synergy_redundancy_only(
        all_routing_weights, args, framework="synergy_redundancy_only", fusion=fusion
    )
