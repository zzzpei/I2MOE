...
class MetricsTop():
    ...
    def __eval_sleepedf20_classification(self, y_pred, y_true):
        ...
        f1_5 = f1_score(y_true, y_pred_5, average='weighted')
        f1_macro = f1_score(y_true, y_pred_5, average='macro')  # 宏平均F1
        precision_5 = precision_score(y_true, y_pred_5, average='weighted')
        recall_5 = recall_score(y_true, y_pred_5, average='weighted')
        
        # 计算每个类别的F1分数
        f1_per_class = f1_score(y_true, y_pred_5, average=None)
        precision_per_class = precision_score(y_true, y_pred_5, average=None)
        recall_per_class = recall_score(y_true, y_pred_5, average=None)
